...
const Hero: React.FC = () => {
  return (
    <div data-w-id="a22c0ce7-c5f2-252a-11a6-aa2c0b174c1f" className="top-section full-width-image-right v2">
      <div className="container-default position-relative---z-index-1 w-container">
        ...
        >
          ...
          <div className="buttons-row">
            <a href="/pricing" className="btn-primary white button-row w-button">Get started</a>
            <a 
        ...
        >
          <img 
            ...
            loading="lazy" 
            alt="The Credit Card Of The Future - UnityLend" 
